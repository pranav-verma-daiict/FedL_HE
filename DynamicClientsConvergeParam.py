...
# Initialize clients
clientNum = 10
print("Total clients:", clientNum)
clients = [Client(data_splits[i]) for i in range(clientNum)]
...
def federated_learning_server(clients):
    while True:
        ...
        selected_clients = random.sample(clients[1:], 5)
